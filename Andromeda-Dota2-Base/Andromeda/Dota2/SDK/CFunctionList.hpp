...
public:
	CBasePattern CGameEntitySystem_GetLocalPlayerController = { "CGameEntitySystem::GetLocalPlayerController" , "E8 ? ? ? ? 48 89 44 24 ? 48 8B F8 48 85 C0 0F 84 ? ? ? ? 4C 89 AC 24 ? ? ? ? 48 8D 54 24" , CLIENT_DLL , 0 , SEARCH_TYPE_CALL };
